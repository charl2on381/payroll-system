    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
		  ...
		  <ul class="treeview-menu">
            <li><a href="empdeduct.php"><i class="fa fa-circle-o"></i> Deduction List</a></li>
            <li><a href="deductiontype.php"><i class="fa fa-circle-o"></i> Deduction Type</a></li>
            <!--<li><a href="schedule.php"><i class="fa fa-circle-o"></i> Schedules</a></li>-->
          </ul>
        </li>
        <li><a href="deduction.php"><i class="fa fa-file-text"></i> Deductions</a></li>
		<li><a href="deductiontype.php"><i class="fa fa-file-text"></i> Deduction Type</a></li>
